...
inline int RenderCopy(SDL_Renderer* renderer, SDL_Texture* texture,
...
inline int RenderCopyEx(SDL_Renderer* renderer, SDL_Texture* texture,
						const SDL_Rect* src, const SDL_Rect* dest,
...
inline Texture* CreateTextureFromSurface(SDL_Renderer* renderer,
										 SDL_Surface* surface)
{
...
inline int QueryTexture(SDL_Texture* texture, Uint32* format, int* access,
						int* w, int* h)
{
