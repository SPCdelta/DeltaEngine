...
std::shared_ptr<GameObject> UIFactory::CreateText(Scene* scene, const std::string& text, const std::string& font, int fontSize, const Rendering::Color color)
{
...
std::shared_ptr<GameObject> UIFactory::CreateButton(Scene* scene, const std::string& text, const std::string& font, int fontSize, const Rendering::Color textColor, 
	Layer layer)
{
...
std::shared_ptr<GameObject> UIFactory::CreateImage(Scene* scene, const std::string& spriteName, Layer layer)
{
