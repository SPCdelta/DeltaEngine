...
void Shop::Buy() {
	// met een klik hier komt het item binnen dat gekocht gaat worden
	// koop item
	// haal coins eraf van speler

}

void Shop::Sell() {
	// via een klik in de view komt het item binnen dat verkocht gaat worden
	// verkoop item
	// doe coins teruggeven aan de speler
}
