...
ShieldBarComponent::ShieldBarComponent(Scene& scene, const std::string& fontName, const Math::Vector2& startPos, const Math::Vector2& scale, Player* player) 
...
void ShieldBarComponent::InitValues(Player* player)
{
	...
	_maxValue = 100; // Max shield is set to 100 since it has not been defined.
